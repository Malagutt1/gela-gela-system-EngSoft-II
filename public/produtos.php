...
<head>
    ...
    <title>Gela-Gela | Estoque & Produtos</title>
        ...
        <main class="content">
            ...
            <section class="main">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
                    <h2><i class="fa-solid fa-boxes-stacked"></i> Gerenciamento de Produtos</h2>
                    <button class="btn btn-produto" onclick="abrirModal()">
                        ...
                        <table>
                            ...
                            <tbody id="tabela-produtos">
                                <tr>
                                    ...
                                    <td>R$ 28,00/kg</td>
                                    <td><strong class="badge ok">35 kg</strong></td>
                                    <td>15/06/2026</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="tag-resumo">Sorvete</span></td>
                                    <td>R$ 28,00/kg</td>
                                    <td><strong class="badge warn">25 kg</strong></td>
                                    <td>20/05/2026</td>
                                    <td>
                                        <button class="btn-icon btn-editar" onclick="editarProduto(this)">
                                            <i class="fa-solid fa-pen"></i>
                                ...
                                <tr>
                                    <td>Embalagens/Copos</td>
                                    <td><span class="tag-resumo">Insumo</span></td>
                                    <td>R$ 0,45/un</td>
                                    <td><strong class="badge ok">5.000 un</strong></td>
                                    <td>N/A</td>
                                    <td>
                                        <button class="btn-icon btn-editar" onclick="editarProduto(this)">
                                            <i class="fa-solid fa-pen"></i>
                        ...
                        <form id="formProduto" onsubmit="salvarProduto(event)">
                            <div class="grid-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="p-venda" step="0.01" id="campo-preco">
                                </div>
                                <div class="form-group">
                                    <label>Qtd. Inicial</label>
                                    <input type="number" id="p-qtd">
                                </div>
                                <div class="form-group">
                                    <label>Unidade</label>
                                    <input type="text" id="p-un" placeholder="kg, un, lt">
                                </div>
                                <div class="form-group">
                                    <label>Validade</label>
                                    <input type="date" id="p-validade">
                                </div>
                                <div class="form-group">
                            ...
                            <div style="margin-top: 20px; display: flex; gap: 10px; justify-content: flex-end;">
                                <button type="button" class="btn btn-produto btn-secondary"
                                    onclick="fecharModal()">Cancelar</button>
                                <button type="submit" class="btn btn-produto">Salvar Produto</button>
                            </div>
                        </form>
                    </div>
                </div>
